 ...
 */ (function (aI, aG) {
        ...
        for (v = 1; v < u; v++) {
            ...
            if (s === "*") {
                ...
                if (r !== "*" && r !== s) {
                    ...
                    }!p && !b && aC.error("No conversion from " + q.replace(" ", " to ")), p !== !0 && (y = p ? p(y) :
                        b(d(y)))
                }
            }
        }
    ...
    function cA(f, d, h, g) {
        ...
        }) : h || d == null || typeof d !== "object" ? g(f, d) : aC.isArray(d) || aC.isEmptyObject(d) ? g(f, "") : aC.each(
            d, function (a, c) {
            cA(f + "[" + a + "]", c, h, g)
        })
    }
    function cB(v, u, t, s, r, q) {
        ...
        var p = v[r],
            ...
            b;
        for (; o < n && (m || !b); o++) {
            b = p[o](u, t, s), typeof b === "string" && (q[b] ? b = aG : (u.dataTypes.unshift(b), b = cB(v, u, t, s, b,
                q)))
    ...
    function cC(b) {
        return function (a, p) {
            ...
            if (aC.isFunction(p)) {
                var o = a.toLowerCase().split(at),
                    n = 0,
                    m = o.length,
                    l, k, d;
                for (; n < m; n++) {
                    l = o[n], d = /^\+/.test(l), d && (l = l.substr(1) || "*"), k = b[l] = b[l] || [], k[d ? "unshift" :
                        "push"](p)
                }
            }
        }
    ...
    function aO(g, d, j) {
        ...
        aC.each(i, function () {
            j || (h -= parseFloat(aC.css(g, "padding" + this)) || 0), j === "margin" ? h += parseFloat(aC.css(g,
                "margin" + this)) || 0 : h -= parseFloat(aC.css(g, "border" + this + "Width")) || 0
        });
        return h
    }
    function aL(d, c) {
        c.src ? aC.ajax({
            ...
            async: !1,
            dataType: "script"
        }) : aC.globalEval(c.text || c.textContent || c.innerHTML || ""), c.parentNode && c.parentNode.removeChild(c)
    }
    function cI(e, d) {
        if (d.nodeType === 1) {
    ...
    function aT(d, c) {
        return aC.nodeName(d, "table") ? d.getElementsByTagName("tbody")[0] || d.appendChild(d.ownerDocument.createElement(
            "tbody")) : d
    }
    function b3(f, d, h) {
        if (aC.isFunction(d)) {
    ...
    function cg(J) {
        ...
        if (J.liveFired !== this && o && o.live && !J.target.disabled && (!J.button || J.type !== "click")) {
            J.namespace && (x = new RegExp("(^|\\.)" + J.namespace.split(".").join("\\.(?:.*\\.)?") + "(\\.|$)")), J.liveFired =
                this;
            ...
            for (B = 0, A = v.length; B < A; B++) {
                ...
                J.currentTarget = F.elem, J.data = F.handleObj.data, J.handleObj = F.handleObj, w = F.handleObj.origHandler
    ...
    function ay(b, h, e) {
        if (e === aG && b.nodeType === 1) {
            ...
            if (typeof e === "string") {
                try {
                    e = e === "true" ? !0 : e === "false" ? !1 : e === "null" ? null : aC.isNaN(e) ? aA.test(e) ? aC.parseJSON(
                        e) : e : parseFloat(e)
                } catch (d) {}
                aC.data(b, h, e)
            } else {
            ...
            bl.fn = bl.prototype = {
                ...
                init: function (d, p, o) {
                    ...
                    if (typeof d === "string") {
                        ...
                        if (n[1]) {
                            p = p instanceof bl ? p[0] : p, h = p ? p.ownerDocument || p : aE, l = bc.exec(d), l ? bl.isPlainObject(
                                p) ? (d = [aE.createElement(l[1])], bl.fn.attr.call(d, p, !0)) : d = [h.createElement(l[
                                    1])] : (l = bl.buildFragment([n[1]], [h]), d = (l.cacheable ? bl.clone(l.fragment) :
                                l.fragment).childNodes);
                ...
                pushStack: function (f, d, h) {
                    ...
                    bl.isArray(f) ? S.apply(g, f) : bl.merge(g, f), g.prevObject = this, g.context = this.context, d ===
                        "find" ? g.selector = this.selector + (this.selector ? " " : "") + h : d && (g.selector = this.selector +
                        "." + d + "(" + h + ")");
                    return g
                },
                each: function (e, d) {
                ...
                var u, t, s, r, q, p, o = arguments[0] || {}, n = 1,
                    m = arguments.length,
                    d = !1;
                typeof o === "boolean" && (d = o, o = arguments[1] || {}, n = 2), typeof o !== "object" && !bl.isFunction(
                    o) && (o = {}), m === n && (o = this, --n);
                for (; n < m; n++) {
                    if ((u = arguments[n]) != null) {
                        for (t in u) {
                            ...
                            d && r && (bl.isPlainObject(r) || (q = bl.isArray(r))) ? (q ? (q = !1, p = s && bl.isArray(
                                s) ? s : []) : p = s && bl.isPlainObject(s) ? s : {}, o[t] = bl.extend(d, p, r)) : r !==
                                aG && (o[t] = r)
                        }
                    }
                }
                ...
                parseXML: function (d, g, f) {
                    aI.DOMParser ? (f = new DOMParser, g = f.parseFromString(d, "text/xml")) : (g = new ActiveXObject(
                        "Microsoft.XMLDOM"), g.async = "false", g.loadXML(d)), f = g.documentElement, (!f || !f.nodeName ||
                        f.nodeName === "parsererror") && bl.error("Invalid XML: " + d);
                    return g
                },
                noop: function () {},
                globalEval: function (f) {
                    if (f && bg.test(f)) {
                        var d = aE.getElementsByTagName("head")[0] || aE.documentElement,
                            g = aE.createElement("script");
                        g.type = "text/javascript", bl.support.scriptEval() ? g.appendChild(aE.createTextNode(f)) : g.text =
                            f, d.insertBefore(g, d.firstChild), d.removeChild(g)
                    }
                },
                ...
                makeArray: function (f, d) {
                    ...
                    if (f != null) {
                        var g = bl.type(f);
                        f.length == null || g === "string" || g === "function" || g === "regexp" || bl.isWindow(f) ? S.call(
                            h, f) : bl.merge(h, f)
                    }
                    return h
                },
                ...
                proxy: function (d, g, f) {
                    arguments.length === 2 && (typeof g === "string" ? (f = d, d = f[g], g = aG) : g && !bl.isFunction(
                        g) && (f = g, g = aG)), !g && d && (g = function () {
                        ...
                        d, j, i, h = {
                                ...
                                if (!i) {
                                    ...
                                    for (n = 0, m = o.length; n < m; n++) {
                                        l = o[n], f = bl.type(l), f === "array" ? h.done.apply(h, l) : f === "function" &&
                                            g.push(l)
                                    }
                ...
                when: function (h) {
                    var d = arguments,
                        l = d.length,
                        k = l <= 1 && h && bl.isFunction(h.promise) ? h : bl.Deferred(),
                        j = k.promise(),
                        i;
                ...
                sub: function () {
                    ...
                    bl.extend(!0, f, this), f.superclass = this, f.fn = f.prototype = this(), f.fn.constructor = f, f.subclass =
                        this.subclass, f.fn.init = function d(e, h) {
                ...
                browser: {}
            }), b = bl._Deferred(), bl.each("Boolean Number String Function Array Date RegExp Object".split(" "), function (
                e, d) {
                K["[object " + d + "]"] = d.toLowerCase()
            }), L = bl.uaMatch(N), L.browser && (bl.browser[L.browser] = !0, bl.browser.version = L.version), bl.browser
                .webkit && (bl.browser.safari = !0), M && (bl.inArray = function (e, d) {
                return M.call(d, e)
    ...
    (function () {
        ...
        var q = r.getElementsByTagName("*"),
            p = r.getElementsByTagName("a")[0],
            o = aE.createElement("select"),
            n = o.appendChild(aE.createElement("option"));
        if (q && q.length && p) {
            aC.support = {
            ...
            }, o.disabled = !0, aC.support.optDisabled = !n.disabled, aC.support.scriptEval = function () {
                if (aC.support._scriptEval === null) {
                    var h = aE.documentElement,
                        k = aE.createElement("script"),
                        j = "script" + aC.now();
                    k.type = "text/javascript";
                    try {
                        k.appendChild(aE.createTextNode("window." + j + "=1;"))
                    } catch (i) {}
                    h.insertBefore(k, h.firstChild), aI[j] ? (aC.support._scriptEval = !0, delete aI[j]) : aC.support._scriptEval = !
                        1, h.removeChild(k), h = k = j = null
                }
            ...
            }), r.cloneNode(!0).fireEvent("onclick")), r = aE.createElement("div"), r.innerHTML =
            ...
            c.appendChild(r.firstChild), aC.support.checkClone = c.cloneNode(!0).cloneNode(!0).lastChild.checked, aC(function () {
                var g = aE.createElement("div"),
                    f = aE.getElementsByTagName("body")[0];
                if (f) {
                    g.style.width = g.style.paddingLeft = "1px", f.appendChild(g), aC.boxModel = aC.support.boxModel =
                        g.offsetWidth === 2, "zoom" in g.style && (g.style.display = "inline", g.style.zoom = 1, aC.support
                        .inlineBlockNeedsLayout = g.offsetWidth === 2, g.style.display = "", g.innerHTML =
                        "<div style='width:4px;'></div>", aC.support.shrinkWrapBlocks = g.offsetWidth !== 2), g.innerHTML =
                        "<table><tr><td style='padding:0;border:0;display:none'></td><td>t</td></tr></table>";
                    var h = g.getElementsByTagName("td");
                    aC.support.reliableHiddenOffsets = h[0].offsetHeight === 0, h[0].style.display = "", h[1].style.display =
                        "none", aC.support.reliableHiddenOffsets = aC.support.reliableHiddenOffsets && h[0].offsetHeight ===
                        0, g.innerHTML = "", f.removeChild(g).style.display = "none", g = h = null
                }
            });
            var a = function (f) {
    ...
    aC.extend({
        cache: {},
        uuid: 0,
        expando: "jQuery" + (aC.fn.jquery + Math.random()).replace(/\D/g, ""),
        noData: {
            embed: !0,
        ...
        data: function (t, s, r, q) {
            if (aC.acceptData(t)) {
                var p = aC.expando,
                    ...
                    n, m = t.nodeType,
                    d = m ? aC.cache : t,
                    b = m ? t[aC.expando] : t[aC.expando] && aC.expando;
                if ((!b || q && b && !d[b][p]) && o && r === aG) {
                    return
                }
                b || (m ? t[aC.expando] = b = ++aC.uuid : b = aC.expando), d[b] || (d[b] = {}), typeof s === "object" &&
                    (q ? d[b][p] = aC.extend(d[b][p], s) : d[b] = aC.extend(d[b], s)), n = d[b], q && (n[p] || (n[p] = {}),
                    n = n[p]), r !== aG && (n[s] = r);
                if (s === "events" && !n[s]) {
        ...
        removeData: function (r, q, p) {
            if (aC.acceptData(r)) {
                ...
                var a = m[l][o];
                aC.support.deleteExpando || m != aI ? delete m[l] : m[l] = null, a ? (m[l] = {}, m[l][o] = a) : n && (
                    aC.support.deleteExpando ? delete r[aC.expando] : r.removeAttribute ? r.removeAttribute(aC.expando) :
                    r[aC.expando] = null)
            }
        },
        ...
        data: function (b, p) {
            ...
            d[1] = d[1] ? "." + d[1] : "";
            if (p === aG) {
                o = this.triggerHandler("getData" + d[1] + "!", [d[0]]), o === aG && this.length && (o = aC.data(this[0],
                    b), o = ay(this[0], b, o));
            ...
            return this.each(function () {
                var a = aC(this),
                    c = [d[0], p];
                a.triggerHandler("setData" + d[1] + "!", c), aC.data(this, b, p), a.triggerHandler("changeData" + d[1] +
                    "!", c)
            })
        },
    ...
    var aw = /[\n\t\r]/g,
        ...
        aq = /^(?:href|src|style)$/,
        ap = /^(?:button|input)$/i,
        ao = /^(?:button|input|object|select|textarea)$/i,
        an = /^a(?:rea)?$/i,
        am = /^(?:radio|checkbox)$/i;
    aC.props = {
        "for": "htmlFor",
            ...
            return this.each(function () {
                if (h === "string") {
                    ...
                    if (h === "undefined" || h === "boolean") {
                        this.className && aC._data(this, "__className__", this.className), this.className = this.className ||
                            f === !1 ? "" : aC._data(this, "__className__") || ""
                    }
                }
            })
        },
        ...
        val: function (v) {
                ...
                if (u) {
                    ...
                    if (aC.nodeName(u, "select")) {
                        ...
                        for (var n = p ? s : 0, i = p ? s + 1 : q.length; n < i; n++) {
                            var d = q[n];
                            if (d.selected && (aC.support.optDisabled ? !d.disabled : d.getAttribute("disabled") ===
                                null) && (!d.parentNode.disabled || !aC.nodeName(d.parentNode, "optgroup"))) {
                                v = aC(d).val();
                                if (p) {
                                    return v
                                }
            ...
            return this.each(function (a) {
                var j = aC(this),
                    h = v;
                if (this.nodeType === 1) {
                    b && (h = v.call(this, a, j.val())), h == null ? h = "" : typeof h === "number" ? h += "" : aC.isArray(
                        h) && (h = aC.map(h, function (c) {
                        return c == null ? "" : c + ""
                    }));
        ...
        attr: function (t, s, r, q) {
            ...
            var m = t.nodeType !== 1 || !aC.isXMLDoc(t),
                l = r !== aG;
            s = m && aC.props[s] || s;
            if (t.nodeType === 1) {
                var k = aq.test(s);
                ...
                if ((s in t || t[s] !== aG) && m && !k) {
                    l && (s === "type" && ap.test(t.nodeName) && t.parentNode && aC.error(
                        "type property can't be changed"), r === null ? t.nodeType === 1 && t.removeAttribute(s) : t[s] =
                        r);
                    ...
                    if (s === "tabIndex") {
                        ...
                        return d && d.specified ? d.value : ao.test(t.nodeName) || an.test(t.nodeName) && t.href ? 0 :
                            aG
                    }
                    return t[s]
                }
    ...
    aC.event = {
        add: function (B, A, z, y) {
            if (B.nodeType !== 3 && B.nodeType !== 8) {
                ...
                typeof u === "function" ? (t = u.handle, u = u.events) : u || (B.nodeType || (v[af] = v = function () {}),
                    ...
                    return typeof aC !== "undefined" && !aC.event.triggered ? aC.event.handle.apply(t.elem, arguments) :
                        aG
                }), t.elem = B, A = A.split(" ");
                var s, r = 0,
                    d;
                while (s = A[r++]) {
                    w = x ? aC.extend({}, x) : {
                        handler: z,
                        data: y
                    }, s.indexOf(".") > -1 ? (d = s.split("."), s = d.shift(), w.namespace = d.slice(0).sort().join(".")) :
                        (d = [], w.namespace = ""), w.type = s, w.guid || (w.guid = z.guid);
                    var b = u[s],
                        a = aC.event.special[s] || {};
                    if (!b) {
                        b = u[s] = [];
                        if (!a.setup || a.setup.call(B, y, d, t) === !1) {
                            B.addEventListener ? B.addEventListener(s, t, !1) : B.attachEvent && B.attachEvent("on" + s,
                                t)
                        }
                    }
                    a.add && (a.add.call(B, w), w.handler.guid || (w.handler.guid = z.guid)), b.push(w), aC.event.global[
                        s] = !0
                }
                B = null
            }
        ...
        remove: function (L, K, J, I) {
            if (L.nodeType !== 3 && L.nodeType !== 8) {
                J === !1 && (J = ae);
                var H, G, F, E, D = 0,
                    C, B, A, z, y, v, u, t = aC.hasData(L) && aC._data(L),
                    d = t && t[af];
                if (!t || !d) {
                    return
                }
                ...
                K = K.split(" ");
                while (G = K[D++]) {
                    u = G, v = null, C = G.indexOf(".") < 0, B = [], C || (B = G.split("."), G = B.shift(), A = new RegExp(
                        "(^|\\.)" + aC.map(B.slice(0).sort(), ag).join("\\.(?:.*\\.)?") + "(\\.|$)")), y = d[G];
                    if (!y) {
                        continue
                    }
                    if (!J) {
                    ...
                    if (y.length === 0 || I != null && y.length === 1) {
                        (!z.teardown || z.teardown.call(L, B) === !1) && aC.removeEvent(L, G, t.handle), H = null,
                            delete d[G]
                    }
                }
                if (aC.isEmptyObject(d)) {
                    var b = t.handle;
                    b && (b.elem = null), delete t.events, delete t.handle, typeof t === "function" ? aC.removeData(L,
                        af, !0) : aC.isEmptyObject(t) && aC.removeData(L, aG, !0)
                }
            }
        },
        trigger: function (B, A, z) {
            var y = B.type || B,
                x = arguments[3];
            if (!x) {
                B = typeof B === "object" ? B[aC.expando] ? B : aC.extend(aC.Event(y), B) : aC.Event(y), y.indexOf("!") >=
                    0 && (B.type = y = y.slice(0, -1), B.exclusive = !0), z || (B.stopPropagation(), aC.event.global[y] &&
                    aC.each(aC.cache, function () {
                    var a = aC.expando,
                        c = this[a];
            ...
            try {
                z && z.nodeName && aC.noData[z.nodeName.toLowerCase()] || z["on" + y] && z["on" + y].apply(z, A) === !1 &&
            ...
            if (!B.isPropagationStopped() && v) {
                ...
                if (!B.isDefaultPrevented()) {
                    var t, s = B.target,
                        r = y.replace(al, ""),
                        o = aC.nodeName(s, "a") && r === "click",
                        d = aC.event.special[r] || {};
                    if ((!d._default || d._default.call(z, B) === !1) && !o && !(s && s.nodeName && aC.noData[s.nodeName
                        .toLowerCase()])) {
                        try {
        ...
        handle: function (x) {
            var w, v, u, t, s, r = [],
                q = aC.makeArray(arguments);
            x = q[0] = aC.event.fix(x || aI.event), x.currentTarget = this, w = x.type.indexOf(".") < 0 && !x.exclusive,
                w || (u = x.type.split("."), x.type = u.shift(), r = u.slice(0).sort(), t = new RegExp("(^|\\.)" + r.join(
                "\\.(?:.*\\.)?") + "(\\.|$)")), x.namespace = x.namespace || r.join("."), s = aC._data(this, af),
                typeof s === "function" && (s = s.events), v = (s || {})[x.type];
            if (s && v) {
                v = v.slice(0);
        ...
        fix: function (b) {
            ...
            b.target || (b.target = b.srcElement || aE), b.target.nodeType === 3 && (b.target = b.target.parentNode), !
            ...
            if (b.pageX == null && b.clientX != null) {
                var d = aE.documentElement,
                    c = aE.body;
                b.pageX = b.clientX + (d && d.scrollLeft || c && c.scrollLeft || 0) - (d && d.clientLeft || c && c.clientLeft ||
                    0), b.pageY = b.clientY + (d && d.scrollTop || c && c.scrollTop || 0) - (d && d.clientTop || c && c
                    .clientTop || 0)
            }
            b.which == null && (b.charCode != null || b.keyCode != null) && (b.which = b.charCode != null ? b.charCode :
                b.keyCode), !b.metaKey && b.ctrlKey && (b.metaKey = b.ctrlKey), !b.which && b.button !== aG && (b.which =
                b.button & 1 ? 1 : b.button & 2 ? 3 : b.button & 4 ? 2 : 0);
            return b
        },
        guid: 100000000,
        proxy: aC.proxy,
        special: {
            ...
            live: {
                add: function (b) {
                    aC.event.add(this, ce(b.origType, b.selector), aC.extend({}, b, {
                        handler: cg,
                        guid: b.handler.guid
                    }))
                },
        ...
        b && b.type ? (this.originalEvent = b, this.type = b.type, this.isDefaultPrevented = b.defaultPrevented || b.returnValue === !
            1 || b.getPreventDefault && b.getPreventDefault() ? ad : ae) : this.type = b, this.timeStamp = aC.now(),
            this[aC.expando] = !0
    }, aC.Event.prototype = {
    ...
    }), aC.support.submitBubbles || (aC.event.special.submit = {
        setup: function (b, d) {
    ...
    if (!aC.support.changeBubbles) {
        var aa, cp = function (e) {
                var d = e.type,
                    f = e.value;
                d === "radio" || d === "checkbox" ? f = e.checked : d === "select-multiple" ? f = e.selectedIndex > -1 ?
                    aC.map(e.options, function (b) {
                    return b.selected
                ...
                if (ak.test(h.nodeName) && !h.readOnly) {
                    g = aC._data(h, "_change_data"), d = cp(h), (b.type !== "focusout" || h.type !== "radio") && aC._data(
                        h, "_change_data", d);
                    if (g === aG || d === g) {
                        return
                    }
        ...
        aC.event.special.change = {
            filters: {
                ...
                keydown: function (e) {
                    var d = e.target,
                        f = d.type;
                    if (e.keyCode === 13 && d.nodeName.toLowerCase() !== "textarea" || e.keyCode === 32 && (f ===
                        "checkbox" || f === "radio") || f === "select-multiple") {
                        return cn.call(this, e)
                    }
                },
    ...
    function () {
        ...
        var A = function (M, K, J, I) {
            ...
            if (N.length > 1 && y.exec(M)) {
                ...
                !I && N.length > 1 && K.nodeType === 9 && !O && z.match.ID.test(N[0]) && !z.match.ID.test(N[N.length -
                    1]) && (f = A.find(N.shift(), K, O), K = f.expr ? A.filter(f.expr, f.set)[0] : f.set[0]);
                if (K) {
                    f = I ? {
                        expr: N.pop(),
                        set: v(I)
                    } : A.find(N.pop(), N.length === 1 && (N[0] === "~" || N[0] === "+") && K.parentNode ? K.parentNode :
                        K, O), k = f.expr ? A.filter(f.expr, f.set) : f.set, N.length > 0 ? j = v(k) : P = !1;
                    while (N.length) {
                        a = N.pop(), R = a, z.relative[a] ? R = N.pop() : a = "", R == null && (R = K), z.relative[a](j,
                            R, O)
                    }
                } else {
                    j = N = []
        ...
        var z = A.selectors = {
            ...
            relative: {
                ...
                "": function (h, e, l) {
                    var k, j = E++,
                        i = H;
                    typeof e === "string" && !/\W/.test(e) && (e = e.toLowerCase(), k = e, i = b), i("parentNode", e, j,
                        h, k, l)
                },
                "~": function (h, e, l) {
                    var k, j = E++,
                        i = H;
                    typeof e === "string" && !/\W/.test(e) && (e = e.toLowerCase(), k = e, i = b), i("previousSibling",
                        e, j, h, k, l)
                }
            },
            find: {
            ...
            preFilter: {
                ...
                CHILD: function (f) {
                    if (f[1] === "nth") {
                        ...
                        var e = /(-?)(\d*)(?:n([+\-]?\d*))?/.exec(f[2] === "even" && "2n" || f[2] === "odd" && "2n+1" || !
                            /\D/.test(f[2]) && "0n+" + f[2] || f[2]);
                ...
                ATTR: function (i, h, n, m, l, k) {
                    ...
                    !k && z.attrMap[j] && (i[1] = z.attrMap[j]), i[4] = (i[4] || i[5] || "").replace(/\\/g, ""), i[2] ===
                        "~=" && (i[4] = " " + i[4] + " ");
                    return i
                },
            ...
            filter: {
                ...
                ATTR: function (i, h) {
                    var n = h[1],
                        m = z.attrHandle[n] ? z.attrHandle[n](i) : i[n] != null ? i[n] : i.getAttribute(n),
                        l = m + "",
                        k = h[2],
                        j = h[4];
                    return m == null ? k === "!=" : k === "=" ? l === j : k === "*=" ? l.indexOf(j) >= 0 : k === "~=" ?
                        (" " + l + " ").indexOf(j) >= 0 : j ? k === "!=" ? l !== j : k === "^=" ? l.indexOf(j) === 0 :
                        k === "$=" ? l.substr(l.length - j.length) === j : k === "|=" ? l === j || l.substr(0, j.length +
                        1) === j + "-" : !1 : l && m !== !1
                },
        ...
        for (var w in z.match) {
            z.match[w] = new RegExp(z.match[w].source + /(?![^\[]*\])(?![^\(]*\))/.source), z.leftMatch[w] = new RegExp(
        ...
        aE.documentElement.compareDocumentPosition ? d = function (f, e) {
            ...
            var e = "",
                h;
            for (var g = 0; f[g]; g++) {
                h = f[g], h.nodeType === 3 || h.nodeType === 4 ? e += h.nodeValue : h.nodeType !== 8 && (e += A.getText(
                    h.childNodes))
            }
            return e
        },
        function () {
            var f = aE.createElement("div"),
                h = "script" + (new Date).getTime(),
                g = aE.documentElement;
            f.innerHTML = "<a name='" + h + "'/>", g.insertBefore(f, g.firstChild), aE.getElementById(h) && (z.find.ID = function (
                i, l, k) {
                if (typeof l.getElementById !== "undefined" && !k) {
                    var j = l.getElementById(i[1]);
                    return j ? j.id === i[1] || typeof j.getAttributeNode !== "undefined" && j.getAttributeNode("id").nodeValue ===
                        i[1] ? [j] : aG : []
                }
        ...
        function () {
            ...
            e.appendChild(aE.createComment("")), e.getElementsByTagName("*").length > 0 && (z.find.TAG = function (g, f) {
                ...
                return j
            }), e.innerHTML = "<a href='#'></a>", e.firstChild && typeof e.firstChild.getAttribute !== "undefined" && e
                .firstChild.getAttribute("href") !== "#" && (z.attrHandle.href = function (f) {
        ...
        aC.find = A, aC.expr = A.selectors, aC.expr[":"] = aC.expr.filters, aC.unique = A.uniqueSort, aC.text = A.getText,
            aC.isXMLDoc = A.isXML, aC.contains = A.contains
    }();
    var cd = /Until$/,
        cb = /^(?:parents|prevUntil|prevAll)/,
        b9 = /,/,
        b8 = /^.[^:#\[\.,]*$/,
        b7 = Array.prototype.slice,
        b6 = aC.expr.match.POS,
        b5 = {
            children: !0,
            contents: !0,
            next: !0,
    ...
    aC.fn.extend({
            ...
            if (aC.isArray(v)) {
                ...
                if (q && v.length) {
                    ...
                    while (q && q.ownerDocument && q !== u) {
                        for (o in n) {
                            p = n[o], (p.jquery ? p.index(q) > -1 : aC(q).is(p)) && t.push({
                                selector: o,
                                elem: q,
                                level: m
                            })
        ...
        add: function (f, d) {
            var h = typeof f === "string" ? aC(f, d) : aC.makeArray(f),
                g = aC.merge(this.get(), h);
        ...
        aC.fn[d] = function (i, h) {
            var b = aC.map(this, c, i),
                a = b7.call(arguments);
            cd.test(d) || (h = i), h && typeof h === "string" && (b = aC.filter(h, b)), b = this.length > 1 && !b5[d] ?
                aC.unique(b) : b, (this.length > 1 || b9.test(h)) && cb.test(d) && (b = b.reverse());
    ...
    var b1 = / jQuery\d+="(?:\d+|null)"/g,
        a9 = /^\s+/,
        a7 = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,
        a5 = /<([\w:]+)/,
        a3 = /<tbody/i,
        a1 = /<|&#?\w+;/,
    ...
    aV.optgroup = aV.option, aV.tbody = aV.tfoot = aV.colgroup = aV.caption = aV.thead, aV.th = aV.td, aC.support.htmlSerialize ||
        (aV._default = [1, "div<div>", "</div>"]), aC.fn.extend({
        text: function (b) {
            if (aC.isFunction(b)) {
                return this.each(function (a) {
                    var d = aC(this);
        ...
        remove: function (f, d) {
            ...
            (g = this[h]) != null; h++) {
                if (!f || aC.filter(f, [g]).length) {
                    !d && g.nodeType === 1 && (aC.cleanData(g.getElementsByTagName("*")), aC.cleanData([g])), g.parentNode &&
        ...
        html: function (b) {
            ...
            if (typeof b !== "string" || aZ.test(b) || !aC.support.leadingWhitespace && a9.test(b) || aV[(a5.exec(b) || [
                    "", ""])[1].toLowerCase()]) {
                ...
                try {
                    for (var h = 0, g = this.length; h < g; h++) {
                        this[h].nodeType === 1 && (aC.cleanData(this[h].getElementsByTagName("*")), this[h].innerHTML =
                            b)
                    }
                } catch (d) {
                    this.empty().append(b)
        ...
        domManip: function (x, w, v) {
            ...
            if (this[0]) {
                r = q && q.parentNode, aC.support.parentNode && r && r.nodeType === 11 && r.childNodes.length === this.length ?
                    u = {
                    fragment: r
                } : u = aC.buildFragment(x, this, p), s = u.fragment, s.childNodes.length === 1 ? t = s = s.firstChild :
                    t = s.firstChild;
                if (t) {
        ...
        d.length === 1 && typeof d[0] === "string" && d[0].length < 512 && j === aE && d[0].charAt(0) === "<" && !aZ.test(
            d[0]) && (aC.support.checkClone || !aX.test(d[0])) && (l = !0, k = aC.fragments[d[0]], k && (k !== 1 && (m =
            k))), m || (m = j.createDocumentFragment(), aC.clean(d, j, m, n)), l && (aC.fragments[d[0]] = k ? m : 1);
        return {
            fragment: m,
            cacheable: l
        }
    }, aC.fragments = {}, aC.each({
        appendTo: "append",
        prependTo: "prepend",
        insertBefore: "before",
        insertAfter: "after",
        ...
        clean: function (B, A, z, y) {
            A = A || aE, typeof A.createElement === "undefined" && (A = A.ownerDocument || A[0] && A[0].ownerDocument ||
                aE);
            var x = [];
            for (var w = 0, v;
            (v = B[w]) != null; w++) {
                ...
                if (typeof v !== "string" || a1.test(v)) {
                    if (typeof v === "string") {
                        ...
                        if (!aC.support.tbody) {
                            var q = a3.test(v),
                                d = u === "table" && !q ? r.firstChild && r.firstChild.childNodes : t[1] === "<table>" && !
                                    q ? r.childNodes : [];
                            for (var c = d.length - 1; c >= 0; --c) {
                                aC.nodeName(d[c], "tbody") && !d[c].childNodes.length && d[c].parentNode.removeChild(d[
                                    c])
                            }
                        }!aC.support.leadingWhitespace && a9.test(v) && r.insertBefore(A.createTextNode(a9.exec(v)[0]),
                            r.firstChild), v = r.childNodes
                    }
                } else {
            ...
            if (z) {
                for (w = 0; x[w]; w++) {
                    !y || !aC.nodeName(x[w], "script") || x[w].type && x[w].type.toLowerCase() !== "text/javascript" ?
                        (x[w].nodeType === 1 && x.splice.apply(x, [w + 1, 0].concat(aC.makeArray(x[w].getElementsByTagName(
                        "script")))), z.appendChild(x[w])) : y.push(x[w].parentNode ? x[w].parentNode.removeChild(x[w]) :
                        x[w])
                }
            }
            return x
    ...
    aC.fn.css = function (b, d) {
        ...
        cssProps: {
            "float": aC.support.cssFloat ? "cssFloat" : "styleFloat"
        },
        style: function (r, q, p, o) {
            if (r && r.nodeType !== 3 && r.nodeType !== 8 && r.style) {
                var n, m = aC.camelCase(q),
                    l = r.style,
                    d = aC.cssHooks[m];
                q = aC.cssProps[m] || m;
                if (p === aG) {
    ...
    }), aC.support.opacity || (aC.cssHooks.opacity = {
        get: function (d, c) {
            return b0.test((c && d.currentStyle ? d.currentStyle.filter : d.style.filter) || "") ? parseFloat(RegExp.$1) /
                100 + "" : c ? "1" : ""
        },
        set: function (g, d) {
            var j = g.style;
            j.zoom = 1;
            var i = aC.isNaN(d) ? "" : "alpha(opacity=" + d * 100 + ")",
                h = j.filter || "";
        ...
        if (d = i.getComputedStyle(b, null)) {
            j = d.getPropertyValue(k), j === "" && !aC.contains(b.ownerDocument.documentElement, b) && (j = aC.style(b,
                k))
        }
        return j
        ...
        var l, k = h.currentStyle && h.currentStyle[g],
            ...
            i = h.style;
        !a4.test(k) && a2.test(k) && (l = i.left, j && (h.runtimeStyle.left = h.currentStyle.left), i.left = g ===
            "fontSize" ? "1em" : k || 0, k = i.pixelLeft + "px", i.left = l, j && (h.runtimeStyle.left = j));
        return k === "" ? "auto" : k
    }), aU = aS || aQ, aC.expr && aC.expr.filters && (aC.expr.filters.hidden = function (e) {
        var d = e.offsetWidth,
            f = e.offsetHeight;
        return d === 0 && f === 0 || !aC.support.reliableHiddenOffsets && (e.style.display || aC.css(e, "display")) ===
            "none"
    ...
    var aN = /%20/g,
        ...
        aJ = /#.*$/,
        aH = /^(.*?):\s*(.*?)\r?$/mg,
        aF = /^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
        aD = /^(?:GET|HEAD)$/,
        aB = /^\/\//,
        az = /\?/,
        ax = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,
    ...
    aC.fn.extend({
        load: function (i, d, n) {
            ...
            var k = "GET";
            d && (aC.isFunction(d) ? (n = d, d = null) : typeof d === "object" && (d = aC.param(d, aC.ajaxSettings.traditional),
                k = "POST"));
            var j = this;
            aC.ajax({
                url: i,
        ...
        ajaxSettings: {
            ...
            converters: {
                "* text": aI.String,
                "text html": !0,
                "text json": aC.parseJSON,
                "text xml": aC.parseXML
            }
        },
        ajaxPrefilter: cC(cE),
        ajaxTransport: cC(cD),
        ajax: function (T, S) {
            function A(o, k, j, i) {
                if (D !== 2) {
                    ...
                    B.status = o, B.statusText = k, h ? O.resolveWith(Q, [g, k, B]) : O.rejectWith(Q, [B, k, f]), B.statusCode(
                        M), M = aG, R.global && P.trigger("ajax" + (h ? "Success" : "Error"), [B, R, h ? g : f]), N.resolveWith(
                        Q, [B, k]), R.global && (P.trigger("ajaxComplete", [B, R]), --aC.active || aC.event.trigger(
                        "ajaxStop"))
                }
            }
            typeof S !== "object" && (S = T, T = aG), S = S || {};
            var R = aC.extend(!0, {}, aC.ajaxSettings, S),
                Q = (R.context = ("context" in S ? S : aC.ajaxSettings).context) || R,
                P = Q === R ? aC.event : aC(Q),
                O = aC.Deferred(),
                N = aC._Deferred(),
                M = R.statusCode || {}, L = {}, K, J, I, H, G = aE.location,
                F = G.protocol || "http:",
                E, D = 0,
                C, B = {
                    readyState: 0,
                    setRequestHeader: function (f, e) {
            ...
            O.promise(B), B.success = B.done, B.error = B.fail, B.complete = N.done, B.statusCode = function (f) {
                ...
                return this
            }, R.url = ("" + (T || R.url)).replace(aJ, "").replace(aB, F + "//"), R.dataTypes = aC.trim(R.dataType ||
                "*").toLowerCase().split(at), R.crossDomain || (E = cG.exec(R.url.toLowerCase()), R.crossDomain = E &&
                (E[1] != F || E[2] != G.hostname || (E[3] || (E[1] === "http:" ? 80 : 443)) != (G.port || (F ===
                "http:" ? 80 : 443)))), R.data && R.processData && typeof R.data !== "string" && (R.data = aC.param(R.data,
                R.traditional)), cB(cE, R, S, B), R.type = R.type.toUpperCase(), R.hasContent = !aD.test(R.type), R.global &&
                aC.active++ === 0 && aC.event.trigger("ajaxStart");
            if (!R.hasContent) {
                R.data && (R.url += (az.test(R.url) ? "&" : "?") + R.data);
                if (R.cache === !1) {
                    var d = aC.now(),
                        c = R.url.replace(cH, "$1_=" + d);
            ...
            R.ifModified && (aC.lastModified[R.url] && (L["if-modified-since"] = aC.lastModified[R.url]), aC.etag[R.url] &&
                (L["if-none-match"] = aC.etag[R.url])), L.accept = R.dataTypes[0] && R.accepts[R.dataTypes[0]] ? R.accepts[
                R.dataTypes[0]] + (R.dataTypes[0] !== "*" ? ", */*; q=0.01" : "") : R.accepts["*"];
            for (C in R.headers) {
            ...
            if (!R.beforeSend || R.beforeSend.call(Q, B, R) !== !1 && D !== 2) {
                ...
                I = cB(cD, R, S, B);
                if (I) {
                    D = B.readyState = 1, R.global && P.trigger("ajaxSend", [B, R]), R.async && R.timeout > 0 && (H =
                        setTimeout(function () {
                        B.abort("timeout")
                    }, R.timeout));
                    try {
    ...
    aC.ajaxSetup({
        ...
        if (r.dataTypes[0] === "jsonp" || q.jsonpCallback || q.jsonp != null || r.jsonp !== !1 && (cw.test(r.url) || p &&
            cw.test(r.data))) {
            var o, n = r.jsonpCallback = aC.isFunction(r.jsonpCallback) ? r.jsonpCallback() : r.jsonpCallback,
                m = aI[n],
                l = r.url,
                d = r.data,
                a = "$1" + n + "$2";
            r.jsonp !== !1 && (l = l.replace(cw, a), r.url === l && (p && (d = d.replace(cw, a)), r.data === d && (l +=
                (/\?/.test(l) ? "&" : "?") + r.jsonp + "=" + n))), r.url = l, r.data = d, aI[n] = function (b) {
                o = [b]
            }, r.complete = [function () {
                    aI[n] = m;
                    if (m) {
        ...
        if (b.crossDomain) {
            ...
            return {
                send: function (d, a) {
                    f = aE.createElement("script"), f.async = "async", b.scriptCharset && (f.charset = b.scriptCharset),
                        f.src = b.url, f.onload = f.onreadystatechange = function (e, g) {
                        if (!f.readyState || /loaded|complete/.test(f.readyState)) {
                            f.onload = f.onreadystatechange = null, c && f.parentNode && c.removeChild(f), f = aG, g ||
                                a(200, "success")
                        }
    ...
    aC.support.ajax = !! cs, aC.support.cors = cs && "withCredentials" in cs, cs = aG, aC.support.ajax && aC.ajaxTransport(function (
        a) {
            ...
            return {
                send: function (l, k) {
                    ...
                    a.username ? j.open(a.type, a.url, a.async, a.username, a.password) : j.open(a.type, a.url, a.async), (!
                        a.crossDomain || a.hasContent) && !l["x-requested-with"] && (l["x-requested-with"] =
                        "XMLHttpRequest");
                    try {
                    ...
                    j.send(a.hasContent && a.data || null), d = function (h, r) {
                        if (d && (r || j.readyState === 4)) {
                            ...
                            if (r) {
                                ...
                                q = q === 0 ? !a.crossDomain || p ? o ? 304 : 0 : 302 : q == 1223 ? 204 : q, k(q, p, g,
                                    o)
                            }
                        }
    ...
    var cq = {}, co = /^(?:toggle|show|hide)$/,
        cm = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,
        ck, ci = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft",
    ...
    aC.fn.extend({
        show: function (i, d, n) {
            ...
            for (var k = 0, j = this.length; k < j; k++) {
                m = this[k], l = m.style.display, !aC._data(m, "olddisplay") && l === "none" && (l = m.style.display =
                    ""), l === "" && aC.css(m, "display") === "none" && aC._data(m, "olddisplay", cf(m.nodeName))
            }
            for (k = 0; k < j; k++) {
        ...
        animate: function (g, d, j, i) {
            ...
            return this[h.queue === !1 ? "each" : "queue"](function () {
                    ...
                    if (n && (o === "height" || o === "width")) {
                        ...
                        if (aC.css(this, "display") === "inline" && aC.css(this, "float") === "none") {
                            if (aC.support.inlineBlockNeedsLayout) {
                                ...
                                f === "inline" ? this.style.display = "inline-block" : (this.style.display = "inline",
                                    this.style.zoom = 1)
                            } else {
                ...
                a.overflow != null && (this.style.overflow = "hidden"), a.curAnim = aC.extend({}, g), aC.each(g, function (
                    u, t) {
                    ...
                    if (co.test(t)) {
                        ...
                        if (r) {
                            var p = parseFloat(r[2]),
                                b = r[3] || "px";
                            b !== "px" && (aC.style(l, u, (p || 1) + b), q = (p || 1) / s.cur() * q, aC.style(l, u, q +
                                b)), r[1] && (p = (r[1] === "-=" ? -1 : 1) * p + q), s.custom(q, p, b)
                        } else {
                            s.custom(q, t, "")
                        }
                    }
        ...
        speed: function (f, d, h) {
            var g = f && typeof f === "object" ? aC.extend({}, f) : {
                complete: h || !h && d || aC.isFunction(f) && f,
                duration: f,
                easing: h && d || d && !aC.isFunction(d) && d
            };
            g.duration = aC.fx.off ? 0 : typeof g.duration === "number" ? g.duration : g.duration in aC.fx.speeds ? aC.fx
                .speeds[g.duration] : aC.fx.speeds._default, g.old = g.complete, g.complete = function () {
        ...
        update: function () {
            this.options.step && this.options.step.call(this.elem, this.now, this), (aC.fx.step[this.prop] || aC.fx.step
                ._default)(this)
        },
        cur: function () {
        ...
        custom: function (h, d, l) {
            ...
            var k = this,
                j = aC.fx;
            this.startTime = aC.now(), this.start = h, this.end = d, this.unit = l || this.unit || "px", this.now =
                this.start, this.pos = this.state = 0, i.elem = this.elem, i() && aC.timers.push(i) && !ck && (ck =
                setInterval(j.tick, j.interval))
        },
        show: function () {
            this.options.orig[this.prop] = aC.style(this.elem, this.prop), this.options.show = !0, this.custom(this.prop ===
                "width" || this.prop === "height" ? 1 : 0, this.cur()), aC(this.elem).show()
        },
        hide: function () {
            this.options.orig[this.prop] = aC.style(this.elem, this.prop), this.options.hide = !0, this.custom(this.cur(),
                0)
        },
        step: function (t) {
            var s = aC.now(),
            ...
            var l = this.options.specialEasing && this.options.specialEasing[this.prop],
                d = this.options.easing || (aC.easing.swing ? "swing" : "linear");
            this.pos = aC.easing[l || d](this.state, m, 0, 1, this.options.duration), this.now = this.start + (this.end -
        ...
        step: {
            ...
            _default: function (b) {
                b.elem.style && b.elem.style[b.prop] != null ? b.elem.style[b.prop] = (b.prop === "width" || b.prop ===
                    "height" ? Math.max(0, b.now) : b.now) + b.unit : b.elem[b.prop] = b.now
            }
        }
    ...
    "getBoundingClientRect" in aE.documentElement ? aC.fn.offset = function (B) {
        ...
        var v = x.body,
            ...
            r = u.pageYOffset || aC.support.boxModel && w.scrollTop || v.scrollTop,
            q = u.pageXOffset || aC.support.boxModel && w.scrollLeft || v.scrollLeft,
            p = z.top + r - t,
            d = z.left + q - s;
        return {
            top: p,
        ...
        while ((w = w.parentNode) && w !== q && w !== r) {
            ...
            v = p ? p.getComputedStyle(w, null) : w.currentStyle, n -= w.scrollTop, d -= w.scrollLeft, w === u && (n +=
                w.offsetTop, d += w.offsetLeft, aC.offset.doesNotAddBorder && (!aC.offset.doesAddBorderForTableAndCells || !
                cc.test(w.nodeName)) && (n += parseFloat(v.borderTopWidth) || 0, d += parseFloat(v.borderLeftWidth) ||
                0), t = u, u = w.offsetParent), aC.offset.subtractsBorderForOverflowNotVisible && v.overflow !==
                "visible" && (n += parseFloat(v.borderTopWidth) || 0, d += parseFloat(v.borderLeftWidth) || 0), o = v
        }
        if (o.position === "relative" || o.position === "static") {
            n += q.offsetTop, d += q.offsetLeft
        }
        aC.offset.supportsFixedPosition && o.position === "fixed" && (n += Math.max(r.scrollTop, q.scrollTop), d +=
            Math.max(r.scrollLeft, q.scrollLeft));
        return {
            top: n,
            left: d
        }
        ...
        initialize: function () {
            var d = aE.body,
                ...
                p, o, n, m, l = parseFloat(aC.css(d, "marginTop")) || 0,
                k =
            ...
            aC.extend(c.style, {
                ...
                height: "1px",
                visibility: "hidden"
            }), c.innerHTML = k, d.insertBefore(c, d.firstChild), p = c.firstChild, o = p.firstChild, m = p.nextSibling
                .firstChild.firstChild, this.doesNotAddBorder = o.offsetTop !== 5, this.doesAddBorderForTableAndCells =
                m.offsetTop === 5, o.style.position = "fixed", o.style.top = "20px", this.supportsFixedPosition = o.offsetTop ===
                20 || o.offsetTop === 15, o.style.position = o.style.top = "", p.style.overflow = "hidden", p.style.position =
                "relative", this.subtractsBorderForOverflowNotVisible = o.offsetTop === -5, this.doesNotIncludeMarginInBodyOffset =
                d.offsetTop !== l, d.removeChild(c), d = c = p = o = n = m = null, aC.offset.initialize = aC.noop
        },
        bodyOffset: function (e) {
            var d = e.offsetTop,
                f = e.offsetLeft;
            aC.offset.initialize(), aC.offset.doesNotIncludeMarginInBodyOffset && (d += parseFloat(aC.css(e,
                "marginTop")) || 0, f += parseFloat(aC.css(e, "marginLeft")) || 0);
            return {
                top: d,
                left: f
            }
        ...
        setOffset: function (z, y, x) {
            ...
            var v = aC(z),
                ...
                t = aC.css(z, "top"),
                s = aC.css(z, "left"),
                r = w === "absolute" && aC.inArray("auto", [t, s]) > -1,
                q = {}, p = {}, o, d;
            r && (p = v.position()), o = r ? p.top : parseInt(t, 10) || 0, d = r ? p.left : parseInt(s, 10) || 0, aC.isFunction(
                y) && (y = y.call(z, x, u)), y.top != null && (q.top = y.top - u.top + o), y.left != null && (q.left =
                y.left - u.left + d), "using" in y ? y.using.call(z, q) : v.css(q)
        }
    }, aC.fn.extend({
        position: function () {
            if (!this[0]) {
            ...
            var f = this[0],
                d = this.offsetParent(),
                h = this.offset(),
                g = ca.test(d[0].nodeName) ? {
                    top: 0,
                    left: 0
                } : d.offset();
            h.top -= parseFloat(aC.css(f, "marginTop")) || 0, h.left -= parseFloat(aC.css(f, "marginLeft")) || 0, g.top +=
                parseFloat(aC.css(d[0], "borderTopWidth")) || 0, g.left += parseFloat(aC.css(d[0], "borderLeftWidth")) ||
                0;
            return {
                top: h.top - g.top,
                left: h.left - g.left
        ...
        aC.fn[d] = function (h) {
            ...
            a = cJ(e);
            return a ? "pageXOffset" in a ? a[b ? "pageYOffset" : "pageXOffset"] : aC.support.boxModel && a.document.documentElement[
                d] || a.document.body[d] : e[d]
        }
        ...
        aC.fn["inner" + f] = function () {
            ...
            if (l.nodeType === 9) {
                return Math.max(l.documentElement["client" + f], l.body["scroll" + f], l.documentElement["scroll" + f],
                    l.body["offset" + f], l.documentElement["offset" + f])
            }
            if (c === aG) {
                var j = aC.css(l, d),
                    e = parseFloat(j);
